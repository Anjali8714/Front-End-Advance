...
// function getstatus (orderId:number , status: keyof typeof statustypes){
//     console.log(orderId , "=" , statustypes[status]);//value return cheyyan
//     // console.log(orderId , "=" , status);   // key retuen cheyyan
// }
